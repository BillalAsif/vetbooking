        ...
        <>
            <div className="container mx-auto mt-4 mb-10 custom-padding">
                ...
                <div className="border-cyan-500 border-2 px-3 py-3">
                        ...
                        <div class="mb-3 xl:w-96 inline-block">
                            <div class="input-group relative flex flex-wrap items-stretch w-full mb-4">
                                <input type="search" class="custom-search form-control relative flex-auto min-w-0 block px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Search" aria-label="Search" aria-describedby="button-addon2" />
